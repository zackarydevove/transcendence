...
export function ConfigureTextBlocks(Interface, points_game, newHeight, newWidth, player_name) {
  ...
  Interface.textBlock6.text = "OPPONNENT NAME";
  ...
  if (player_name.opponent_name != undefined)
    Interface.textBlock7.text = player_name.opponent_name;
  else
  Interface.textBlock7.text = "";
    Interface.textBlock7.color = "#87b9ff";
  Interface.textBlock7.fontSize = 0.03 * newHeight;
  Interface.textBlock7.top = (- newHeight / 2.3) + "px";
  Interface.textBlock7.left = -(newWidth / 2.7) + "px";
  Interface.textBlock7.fontFamily = "Arial"; 
  if (Interface.textBlock7 != undefined && Interface.textBlock7.text != "")
      Interface.advancedTexture.addControl(Interface.textBlock7);
